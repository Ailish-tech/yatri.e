...
- Endpoints: `http://192.168.1.156:3000/api/generateItinerary` e `http://192.168.1.156:3000/api/justchat`
...
- Substitua `192.168.1.156` pelo host da sua API (veja também `src/config.ts` onde há `API_URL` para outros módulos).
